...
class AdminSettings(BaseSettings):
    ADMIN_USER_FIRST_NAME: str = os.getenv("ADMIN_USER_FIRST_NAME", "Admin")
    ADMIN_USER_LAST_NAME: str = os.getenv("ADMIN_USER_LAST_NAME", "User")
    ADMIN_USER_CONTACT_NUMBER: str = os.getenv("ADMIN_USER_CONTACT_NUMBER", "9999999999")
    ADMIN_USER_PASSWORD: str = os.getenv("ADMIN_USER_PASSWORD", "admin123")
    ADMIN_USER_IS_ADMIN: bool = os.getenv("ADMIN_USER_IS_ADMIN", "true").lower() == "true"
    ADMIN_USER_ROLE: str = os.getenv("ADMIN_USER_ROLE", "receptionist")
